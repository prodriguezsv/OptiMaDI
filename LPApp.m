        ...
        if all(isthereintercept > 0)
            ...
            elseif isthereintercept(1) == 1
                if x31 > 0
                    ...
                    points_set{i} = struct('points', [x1 y1 z1; x2 y2 z2; x3 y3 z3; x4 y4 z4], 'tipo', 29);
                elseif x31 == 0
                    if i == Dimension(1)                         
                        x1 = 0; y1 = 0; z1 = 0;
...
for i = 1:Dimension - 1
    if points_set{i}.tipo > 0 && points_set{i}.tipo < 8 
